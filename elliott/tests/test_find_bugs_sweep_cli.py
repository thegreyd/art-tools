...
class FindBugsSweepTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    def test_find_bugs_sweep_default_advisories(self, jira_filter_mock):
        runner = CliRunner()
        image_bugs = [flexmock(id="OCPBUGS-1"), flexmock(id="OCPBUGS-2")]
        rpm_bugs = [flexmock(id="OCPBUGS-3"), flexmock(id="OCPBUGS-4")]
        extras_bugs = [flexmock(id="OCPBUGS-5"), flexmock(id="OCPBUGS-6")]
